          ...
          <div className="col contenedorForm contenedor">
              <div className="mb-3">
                <Fade cascade>
                  ...
                  <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="Nombre y apellido" required="required"/>
                  <p className="form-label">Email address</p>
                  <input type="email" className="form-control" id="exampleFormControlInput1" placeholder="name@example.com" required="required"/>
